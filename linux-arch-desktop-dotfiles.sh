...
deploy_dotfiles() {
    ...
    update_files "$env_base/arch-desktop/env/.config" "$XDG_CONFIG_HOME"
    ...
    deploy_file "$env_base/arch-desktop/env/.zsh_profile"     "$HOME/.zsh_profile"
    deploy_file "$env_base/arch-desktop/env/.zshrc"            "$HOME/.zshrc"
    ...
    deploy_file "$env_base/arch-desktop/env/.local/scripts/tmux-sessionizer"  "$HOME/.local/scripts/tmux-sessionizer"
